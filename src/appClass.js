...
export default class App extends Component {
    constructor(props){
      ...
      this.state={
        fullName:"adem",
        bio: "Hi, I'm adem, a  web developer student creating dynamic and user-friendly websites My expertise lies in front-end development, including HTML, CSS, and JavaScript, as well as various front-end frameworks such as React and Next. I take pride in writing clean, well-documented code that is easy to maintain and scale.",
        imgSrc: "Your Image goes here",
